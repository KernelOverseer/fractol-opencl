...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_GPU_burningship.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: abiri <kerneloverseer@pm.me>               +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/07 22:31:57 by abiri             #+#    #+#             */
/*   Updated: 2019/05/09 17:09:57 by abiri            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	ft_drawpixels(unsigned int *vals, t_env *env)
{
	size_t	i;
	size_t	j;
	int		n;
...
void			ft_gpu_burningship(t_env *env)
{
	...
	localsize = 64;
	n = env->image->width * env->image->height * sizeof(unsigned int);
	vals = ft_memalloc(n);
